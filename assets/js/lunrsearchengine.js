...
var documents = [{
    ...
    "body": "Về bản thân: Mình là Thành, kỹ sư ôtô ở Bỉ, 1 vợ, 2 con. Mình đam mê thử thách bản thân. Blog này cũng là một trong nhưng thử thách bản thân mình tự đặt ra: tập viết. Về 𝔸𝕀trify: Blog 𝔸𝕀trify được lập ra ban đầu để lưu trữ các blogs, tutorials, tricks . . . về lập trình AI, nhưng lập ra rồi thì mình lại nghĩ viết về cái mình biết thì mang lại gì cho bản thân, các bạn muốn học cũng có thể học qua các trang chính thống khác. Thế là mình viết về mình, về những thứ mình thích và quan tâm, để hình thành thói quen viết lách, để hiểu được mình hơn. Đơn giản như thế thôi. Mình thích thử thách bản thân nên mình sẽ viết về các thử thách mình tự đặt ra cho bản thân mình. Vừa giữ cho mình hứng khởi để cố gắng từng ngày, vừa là chỗ rút kinh nghiệm, và tổng hợp lại từng bước mình đã trải qua. Thử thách đang có:: Chạy: Qualify cho Boston Marathon - có 2 cách: chạy nhanh hơn hoặc giữ tốc độ hiện tại cho đến khi . . . 80 tuổiViết: Mỗi tuần viết 2 blogs, publish vào thứ 3 và thứ 7, bắt đầu từ thứ 3 ngày 03/03/2020. Về nội dung blog: Viết thật với bản thân mình quan điểm, kinh nghiệm hay cảm nghĩ, phải thật với mìnhViết có cơ sở dẫn chứng, tính mình hay khái quát hóa, phỏng đoán mà tóm lược như chân lý, cái này phải sửaCuối cùng, phải nhấn mạnh là đây là blog cá nhân, mình viết điều mình muốn viết và chịu trách nhiệm về những gì mình viếtOur Location: Gladioolstraat3800 Sint-TruidenLimburg, BelgiumLoading. . . "
    }, {
    "id": 2,
    ...
    "title": "Home",
    "body": "      Featured:                     All Stories:                                                                                                     Chạy bộ - như mình nghĩ về nó              :       Chạy bộ là môn thể thao đơn giản nhất, chỉ là đưa chân, và chạy. Nó chắc chắn là môn thể thao lâu đời nhất. Mình chạy hôm nay chắc. . . :                                                                               Thành Tiên                03 Mar 2020                                            "
    }, {
    "id": 4,
