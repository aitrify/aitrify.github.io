...
var documents = [{
    ...
    "title": "About us",
    "body": "Our Vision: 𝔸𝕀 is the new electricity. Just like electricity changed how the world operated 100 years ago. 𝔸𝕀 is poised to have a similar impact. We started 𝔸𝕀trifi with a vision of the world engineered by 𝔸𝕀. An type of 𝔸𝕀 that for human, for planet and for a better future. Our Missions: providing AI as valid solutions for diversified problems in human lifemaking AI as a tool easy to access and to useenabling all aspects of AI ecosystem: from hardware, platform, to infrastructure, policies collaborating to boost AI adoption Our Values: Dedication to create better lifeDisruption with real impactPower of PeoplePursuit the ExcellenceOur Location: Gladioolstraat3800 Sint-TruidenLimburg, BelgiumLoading. . . "
    }, {
    "id": 2,
